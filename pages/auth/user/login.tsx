...
const params = {
    ...
    title: `Connexion utilisateur | ${process.env.APP_NAME}`,
    description: `${process.env.APP_NAME}: Page de connexion en tant qu'utilisateur`
}
...
AuthUserLoginPage.getLayout = (page: ReactElement) => <Layout>{page}</Layout>
